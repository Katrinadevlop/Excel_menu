...
def insert_salads_to_template(template_path: str, menu_path: str, output_path: str):
    """
    Извлекает салаты из меню и вставляет их в шаблон в строки A29-A41 (A28 - заголовок).
    ...
    try:
        ...
        # Очищаем диапазон A29-A41 (салаты), A28 - заголовок
        ...
        print(f"\n✅ Готово! Вставлено {inserted_count} салатов в строки A29-A41 (заголовок в A28)")
        return True
